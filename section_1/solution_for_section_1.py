...
# ### https://github.com/mmiimran/linear-algebra-for-data-science/tree/main/section_1
# 
# #### Code for Section 1
...
# Set global figure properties for publication
...
# Define a vector as a Python list datatype
asList = [1, 2, 3]

# Define the same numbers as a dimensionless numpy array
asArray = np.array([1, 2, 3])

# Define the same numbers with orientations
